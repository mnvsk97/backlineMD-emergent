...
const PatientDetailsPage = () => {
  ...
  const timeline = [
    {
      ...
      status: 'completed',
      date: '2024-09-25',
      description: 'First consultation completed successfully'
    },
    {
      title: 'Document Collection',
      status: 'completed',
      date: '2024-09-28',
      description: 'Medical history and insurance documents received'
    },
    {
      title: 'Insurance Verification',
      status: 'in-progress',
      date: '2024-10-01',
      description: 'Verifying coverage with insurance provider'
    },
    {
      title: 'Treatment Planning',
      status: 'pending',
      date: '2024-10-15',
      description: 'Schedule treatment plan discussion'
    }
  ];
  ...
  const notes = [
    {
      date: '2024-10-01',
      author: 'Dr. James O\'Brien',
      content: 'Patient presented with typical symptoms. Vitals within normal range. BP: 125/80, HR: 68 bpm. Discussed treatment options and next steps.'
    },
    {
      date: '2024-09-28',
      author: 'Nurse Sarah Chen',
      content: 'Intake completed. All required documents collected. Patient is cooperative and well-informed.'
    }
  ];
  ...
  // AI Generated Summary (would be from Hyperspell in production)
      ...
      <header className=\"border-b border-gray-200 bg-white sticky top-0 z-10\">
        <div className=\"max-w-7xl mx-auto px-8 py-6\">
          ...
          <div className=\"flex items-start justify-between\">
            ...
            <span className=\"px-3 py-1.5 bg-gray-100 text-gray-700 rounded text-sm font-medium\">
              {patient.status}
            </span>
          </div>
        </div>
      ...
      <main className=\"max-w-7xl mx-auto px-8 py-8\">
        <Tabs defaultValue=\"summary\" className=\"w-full\">
          <TabsList className=\"bg-white border border-gray-200 p-1 rounded-lg mb-6\">
            ...
            <TabsTrigger value=\"tasks\" className=\"data-[state=active]:bg-gray-900 data-[state=active]:text-white\">
              Tasks ({patient.tasks_count})
            </TabsTrigger>
            <TabsTrigger value=\"appointments\" className=\"data-[state=active]:bg-gray-900 data-[state=active]:text-white\">
              Appointments ({patient.appointments_count})
            </TabsTrigger>
            <TabsTrigger value=\"activities\" className=\"data-[state=active]:bg-gray-900 data-[state=active]:text-white\">
              Activities
            </TabsTrigger>
            <TabsTrigger value=\"docs\" className=\"data-[state=active]:bg-gray-900 data-[state=active]:text-white\">
              Docs (5)
            </TabsTrigger>
          </TabsList>
            ...
            <Card className=\"p-6 border border-gray-200\">
              ...
              <div className=\"grid grid-cols-1 md:grid-cols-2 gap-6\">
                <div>
                  ...
                  <p className=\"text-base font-medium text-gray-900 ml-7\">
                  ...
                  <div key={index} className=\"flex gap-4\">
                    <div className=\"flex flex-col items-center\">
                      <div className={`w-8 h-8 rounded-full flex items-center justify-center ${
                        item.status === 'completed' ? 'bg-gray-900' :
                        item.status === 'in-progress' ? 'bg-gray-400' :
                        'bg-gray-200'
                      }`}>
                      ...
                      {index < timeline.length - 1 && (
                        <div className={`w-0.5 h-12 ${
                          item.status === 'completed' ? 'bg-gray-900' : 'bg-gray-200'
                        }`} />
                      )}
                    </div>
              ...
              <div className=\"space-y-6\">
                ...
                <Card className=\"p-6 border border-gray-200\">
                  ...
                  <button
                    ...
                    className=\"w-full py-2 bg-gray-900 text-white rounded-lg hover:bg-gray-800 transition-colors disabled:opacity-50 disabled:cursor-not-allowed font-medium\"
                  >
