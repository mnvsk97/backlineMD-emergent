    ...
    <div className="flex-1 h-screen overflow-hidden flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="max-w-7xl mx-auto px-8 py-8">
          {/* Greeting & Chat Section */}
          <div className="mb-12 text-center">
            <h2 className="text-4xl font-bold text-gray-900 mb-3">Good morning, Dr. O'Brien</h2>
            <p className="text-gray-600 mb-8">Ask me anything about patients, tasks, or use the suggested questions below.</p>
            
            {/* Chat Input */}
            <div className="max-w-3xl mx-auto mb-8">
              <div className="flex items-center gap-3 bg-white border border-gray-200 rounded-xl p-4 shadow-sm hover:shadow-md transition-shadow">
                <input
                  type="text"
                  value={chatInput}
                  onChange={(e) => setChatInput(e.target.value)}
                  onKeyPress={(e) => e.key === 'Enter' && handleChatSubmit()}
                  placeholder="Ask about patients, scheduling, or appointments..."
              ...
              {suggestedActions.map((action, idx) => {
                ...
                return (
                  <button
                    ...
                    className="p-4 bg-gray-50 hover:bg-gray-100 rounded-lg transition-colors text-left border border-gray-200"
                  >
